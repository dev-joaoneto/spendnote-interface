...
const Button = ({
    ...
    primary:
      "bg-primary-500 text-[#051626] font-semibold hover:bg-primary-600 active:translate-y-1 hover:scale-105 transition-transform duration-300 ease-in-out",
...
const renderLoading = () => (
  ...
  return (
        <button type="button" className={`px-5 py-2.5 rounded-xl font-medium transition-all flex items-center justify-center
